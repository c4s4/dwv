 ...
 */
dwv.tool.draw.defaultPolygonLabelText = '';
 ...
 * @class
 */
dwv.tool.draw.PolygonFactory = function () {
  /**
 ...
 */
dwv.tool.draw.PolygonFactory.prototype.isFactoryGroup = function (group) {
 ...
 */
dwv.tool.draw.PolygonFactory.prototype.create = function (
  ...
  var textExpr = '';
  if (typeof dwv.tool.draw.polygonLabelText !== 'undefined') {
    textExpr = dwv.tool.draw.polygonLabelText;
  } else {
    textExpr = dwv.tool.draw.defaultPolygonLabelText;
  }
 ...
 */
dwv.tool.draw.PolygonFactory.prototype.getAnchors = function (shape, style) {
 ...
 * @param {object} _viewController The associated view controller.
 */
dwv.tool.draw.PolygonFactory.prototype.update = function (
